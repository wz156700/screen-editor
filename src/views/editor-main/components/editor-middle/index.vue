    ...
    <div class="ap-editor">
        ...
        <div class="ap-editor-main" ref="editorMain">
            <EditorMain
                ...
                ref="EditorMainRef"
            ></EditorMain>
            <editorWhiteboard :editorMainInfo="editorMainInfo" :positionInfo="positionInfo" :domData="domData" class="ap-editor-mainBoard" :domInfo="domInfo"></editorWhiteboard>
        </div>
    </div>
</template>
...
const emit = defineEmits(["addDOM", "updataDOM", "updataDOMArray", "removeDOM", "selectDom", "updataIndex"]);
