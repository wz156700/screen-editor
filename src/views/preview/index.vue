...
<template>
    <div
        ...
        :style="{
            ...
            background: pageInfo.backgroundColor ? pageInfo.backgroundColor : 'transparent',
        }"
    >
...
<script setup>
import { computed, provide, reactive, ref, toRef, watch, toRaw, getCurrentInstance, onMounted, nextTick } from "vue";
import { useRoute, useRouter } from "vue-router";
import { ElMessage } from "element-plus";
const route = useRoute();
const userRouter = useRouter();
const { indexDBSearch } = getCurrentInstance().appContext.config.globalProperties;
let domDataPage = ref({});
let pageInfo = ref({});
